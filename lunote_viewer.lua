...
@usage
    local conversationviewer = ConversationViewer:new{
        title = _("I can scroll!"),
        text = _("I'll need to be longer than this example to scroll."),
    }
    UIManager:show(conversationviewer)
]]
...
function ConversationViewer:askAnotherQuestion()
  local input_dialog
  input_dialog = InputDialog:new {
    title = _("Ask another question"),
    input = "",
    input_type = "text",
    description = _("Enter your follow-up question."),
    buttons = {
      {
        {
          text = _("Cancel"),
...
function ConversationViewer:onTapClose(arg, ges_ev)
...
function ConversationViewer:onMultiSwipe(arg, ges_ev)
...
function ConversationViewer:onSwipe(arg, ges)
...
function ConversationViewer:onHoldStartText(_, ges)
...
function ConversationViewer:onHoldPanText(_, ges)
  -- Forward Hold events not processed by TextBoxWidget event handler
  -- to our MovableContainer
...
function ConversationViewer:onHoldReleaseText(_, ges)
  -- Forward Hold events not processed by TextBoxWidget event handler
  -- to our MovableContainer
...
function ConversationViewer:onForwardingTouch(arg, ges)
...
function ConversationViewer:onForwardingPan(arg, ges)
...
function ConversationViewer:onForwardingPanRelease(arg, ges)
  -- We can forward onMovablePanRelease() does enough checks
  return self.movable:onMovablePanRelease(arg, ges)
end

function ConversationViewer:handleTextSelection(text, hold_duration, start_idx, end_idx, to_source_index_func)
...
function ConversationViewer:update(new_text)
  UIManager:close(self)
  local updated_viewer = ConversationViewer:new {
    title = self.title,
    text = new_text,
    width = self.width,
    height = self.height,
