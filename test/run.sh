...
status=0
for spec in history_spec.lua sync_spec.lua explain_spec.lua failures_spec.lua update_spec.lua cover_spec.lua history_browser_spec.lua managed_spec.lua obsidian_spec.lua; do
    output=$("$lua" "$spec" 2>&1)
